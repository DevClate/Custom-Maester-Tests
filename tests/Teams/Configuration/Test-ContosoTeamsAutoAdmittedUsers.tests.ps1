...
Describe "Contoso" -Tag "TEAMS.TC.5010", "Teams", "CustomTests", "Configuration", "Security" {
    It "TEAMS.TC.5010: Auto Admitted Users - Auto-admitted users should be restricted to prevent unauthorized access" {
