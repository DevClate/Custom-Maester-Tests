...
Describe "Contoso" -Tag "ENTRA.UF.1001.Canada", "Entra", "CustomTests", "Canada", "Users", "Formatting" {

    It "ENTRA.UF.1001.Canada: Postal Code - All users should have a valid Canadian postal code" {
