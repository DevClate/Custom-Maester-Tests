---
title: TEAMS.TC.5031 - Security end user reporting should be enabled
description: Ensures users can report security concerns directly from Teams
---
...
3. Under **Security** section, find **Users can report security concerns**
4. Set this to **On**
5. Click **Save**
...
- [User reported message settings](https://learn.microsoft.com/en-us/microsoft-365/security/office-365-security/user-submission)
