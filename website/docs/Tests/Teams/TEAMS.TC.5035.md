---
title: TEAMS.TC.5035 - Memes should be disabled
description: Ensures memes are disabled to prevent inappropriate content sharing
---

# TEAMS.TC.5035 - Memes Should Be Disabled
...
3. Under **Content** section, find **Use memes**
4. Set this to **Off**
5. Click **Save**
...
Organizations with casual cultures may choose to enable memes while implementing:
