---
title: ENTRA.UA.1017 - All users should have usageLocation configured
description: Ensures all enabled member users have usageLocation set for license assignment
---
